    ...
    <div class="hiv-stages">
        ...
        <b-container>
            <b-row class="px-3 px-lg-0">
                <b-col class="symptoms px-1 px-lg-0 pb-5" cols="4" lg="3" v-for="threesymptom in threesymptoms" :key="threesymptom.id" v-bind:threesymptom="threesymptoms">
                    <div class="symptoms-img">
                        <img :src="require(`@/assets/symptoms-${threesymptom.image}`)">
                    </div>
